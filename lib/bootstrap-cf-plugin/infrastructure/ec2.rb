  ...
  module Infrastructure
    class Ec2
      ...
      def self.bootstrap(template_file = nil)
        ...
        deploy_release("cf-release", "cf-ec2.yml", "cf-shared-secrets.yml", template_file)
        deploy_release("cf-services-release", "cf-services-ec2.yml", "cf-shared-secrets.yml", template_file)
      ...
      def self.deploy_release(release_name, manifest_name, upstream_manifest, template_file)
        ...
        template_file ||= File.join(cf_release_path, 'templates', 'cf-ec2-template.yml.erb')
      ...
      def self.generate_stub(manifest_name = "cf-ec2.yml", upstream_manifest = nil)
      ...
      def self.generator
        @generator ||= begin
          ...
          BootstrapCfPlugin::Infrastructure::Ec2::Generator.new("aws_ec2_receipt.yml", "aws_rds_receipt.yml")
        end
      end
